...
EXPOSE 8080
CMD npx prisma db push --schema=server/prisma/schema.prisma --accept-data-loss && npx prisma db seed --schema=server/prisma/schema.prisma && npx tsx server/src/index.ts
