...
ENV VITE_FIREBASE_AUTH_DOMAIN=central-one.firebaseapp.com
ENV VITE_FIREBASE_PROJECT_ID=central-one
ENV VITE_FIREBASE_STORAGE_BUCKET=central-one.firebasestorage.app
